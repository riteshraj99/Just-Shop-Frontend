...
function NavBar(){
    ...
    return (
        <Fragment>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light position-sticky p-0" style={{top:0,zIndex:"1000"}}>
                {/* <Link className="navbar-brand" to="/">JustShop</Link> */}
                <Link to="/"><img className="sitelogo" src={'assets/justshopicon.jpg'} alt="logo" style={{width:"100px" , height:"50px"}}/></Link>
